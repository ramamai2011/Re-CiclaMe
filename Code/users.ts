...
const contraseña_input = document.getElementById("password_input") as HTMLInputElement
const repetir_contraseña_input = document.getElementById("repetir_contraseña") as HTMLInputElement
const postal_input = document.getElementById("codigo_postal_input") as HTMLInputElement
